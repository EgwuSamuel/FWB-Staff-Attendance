...
public class LoginActivity extends Activity {
	...
	String userrole;
	private String[] userRoleString = new String[]{"Login","Register"};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		addfacaulty = (Button) findViewById(R.id.buttonaddfaculty);
		username = (EditText) findViewById(R.id.editTextusername);
		password = (EditText) findViewById(R.id.editTextpassword);
		spinnerloginas = (Spinner) findViewById(R.id.spinnerloginas);

		addfacaulty.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				startActivity(new Intent(LoginActivity.this, AddFacultyActivity.class));
			}
