...
public class AddAttandanceSessionActivity<AddAttandanceActivity> extends Activity {
	...
	String branch = "SWB WATERBOARD";
	String year = "FIRST";
	String subject = "SC";

	private String[] branchString = new String[] { "Records", "Loans and advance" , "Distribution" , " Credit Control" , "MIS", "AUDIT"};
	private String[] yearString = new String[] {"FIRST","SECOND","THIRD","FOURTH"};
	private String[] subjectFIRSTString = new String[] {"SC"};


	private String[] subjectFinal = new String[] {"Attendance tracker"};
